	...
	<div class="container shop">
		<form name="product" action="./update_pro.jsp" onsubmit="return checkProduct()" method="post" enctype="multipart/form-data">
		    ...
		    <div class="input-group mb-3 row">
		        ...
		        <input type="text" class="form-control col-md-10" name="productId" value="${ product.productId }">
		    </div>
		    ...
		    <div class="input-group mb-3 row">
		        ...
		        <input type="number" class="form-control col-md-10" name="unitsInStock" value="${ product.unitsInStock }">
		    </div>
		        ...
		        <div class="col-md-10 d-flex align-items-center">
		            <div class="radio-box d-flex">
		                <div class="radio-item mx-5">
		                    <input type="radio" class="form-check-input" name="condition" value="NEW" id="condition-new" <c:if test="${product.condition == 'NEW'}">checked</c:if>> 
		                    <label for="condition-new">신규 제품</label>
		                </div>
		                
		                <div class="radio-item mx-5">
		                    <input type="radio" class="form-check-input" name="condition" value="OLD" id="condition-old" <c:if test="${product.condition == 'OLD'}">checked</c:if>> 
		                    <label for="condition-old">중고 제품</label>
		                </div>
		                
		                <div class="radio-item mx-5">
		                    <input type="radio" class="form-check-input" name="condition" value="RE" id="condition-re" <c:if test="${product.condition == 'RE'}">checked</c:if>> 
